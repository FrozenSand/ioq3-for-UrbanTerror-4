...
/**
 * Tells whether s2 is a substring of s1 (CASE SENSITIVE).
 *
 * @author Daniele Pantaleone
 * @return 1 if we have a substring match, 0 otherwise.
 */
...
/**
 * Tells whether s2 is a substring of s1 (CASE INSENSITIVE).
 *
 * @author Daniele Pantaleone
 * @return 1 if we have a substring match, 0 otherwise.
 */
